...
(function ($) {
    $.monte = function (selector, options) {
        ...
        cssNext = {
            left: $frame.width() - width * scale - $frame.width()/10, 
            top: (height - height * scale) / 2
            //transform: "scale("+scale+")",
            //width: width * scale, 
            //height: height * scale,
        },
        cssPrev = $.extend({}, cssNext, {left: $frame.width()/10}),
        time = false,
        oldTime;
        ...
        function toTop() {
            ...
            $top.addClass('active');
           // $top.find(".inner").animate({"opacity": 1}, oldTime ? time - oldTime : settings.speed);
        ...
        function move(direction) {
            if ((direction > 0 && active < 1) || (direction < 0 && active > -1)) {
                ...
                if (state === -direction) {
                    ...
                    //$top.find(".inner").animate({"opacity": 0}, oldTime ? time - oldTime : settings.speed);
